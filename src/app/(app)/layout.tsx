...
const AppSidebar = dynamic(
  () => import("@/components/layout/AppSidebar").then((mod) => mod.AppSidebar),
  {
    ssr: false,
    loading: () => (
      <div className="w-64 h-screen bg-sidebar animate-pulse hidden md:block" />
    ),
  },
);
const BottomNav = dynamic(
  () => import("@/components/layout/BottomNav").then((mod) => mod.BottomNav),
  {
    ssr: false,
    loading: () => (
      <div className="h-16 w-full bg-background animate-pulse md:hidden" />
    ),
  },
);
const FooterWrapper = dynamic(
  () =>
    import("@/components/layout/FooterWrapper").then(
