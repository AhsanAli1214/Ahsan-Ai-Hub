...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-[100] md:hidden border-t bg-background/80 backdrop-blur-lg safe-area-bottom h-16 flex items-center justify-around px-2">
      {navItems.map((item) => {
